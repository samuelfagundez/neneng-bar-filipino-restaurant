...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-cream px-6 text-center text-ink">
      ...
      <p className="font-display text-6xl font-semibold text-flag-red">404</p>
      ...
      <a
        href="./"
        className="mt-2 rounded-full bg-flag-red px-6 py-3 text-sm font-semibold text-cream transition hover:bg-flag-red/85"
      >
        Volver al inicio
      </a>
    </div>
